package com.evs.dalinkup.net.app;
...
import com.evs.dalinkup.net.utils.LruBitmapCache;
...
public class AppController extends Application {
    ...
    private HostnameVerifier getHostnameVerifier() {
        return new HostnameVerifier() {
            ...
            public boolean verify(String hostname, SSLSession session) {
                ...
                return hv.verify("dalinkup.net", session);
            }
        };
    }
    ...
    private SSLSocketFactory getSSLSocketFactory()
        ...
        InputStream caInput = getResources().openRawResource(R.raw.my); // this cert file stored in \app\src\main\res\raw folder path
